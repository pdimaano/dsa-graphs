...
describe("addVertex", function () {
  it("should add a key in the adjacency", function () {
    ...
    let b = new Node("B");
    let c = new Node("C");
    expect(graph._nodes.has(a)).toBe(false);
    expect(graph._nodes.has(b)).toBe(false);
    expect(graph._nodes.has(c)).toBe(false);
    graph.addVertex(a);
    graph.addVertex(b);
    graph.addVertex(c);
    expect(graph._nodes.has(a)).toBe(true);
    expect(graph._nodes.has(b)).toBe(true);
    expect(graph._nodes.has(c)).toBe(true);
  });
});
...
describe("removeVertex", function () {
  it("should remove the vertex as well as any edges", function () {
    ...
    expect(graph._nodes.has(a)).toBeTruthy();
    expect(graph._nodes.has(b)).toBeTruthy();
    expect(graph._nodes.has(c)).toBeFalsy();
    expect(graph._nodes.has(d)).toBeFalsy();
  });
});
